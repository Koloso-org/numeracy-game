...
const BEGINNER: Question[] = [
  ...
  { id: 'b11', level: 'beginner', topic: 'addition', type: 'entry',
    prompt: 'What is 367 + 248?', answer: '615' },
  { id: 'b12', level: 'beginner', topic: 'fractions', type: 'entry',
    prompt: 'What is 1/4 + 1/2? Give your answer as a fraction.', answer: '3/4', accept: ['3/4'] },
  ...
  { id: 'b18', level: 'beginner', topic: 'coordinates', type: 'entry',
    prompt: 'Write the coordinates of the point (e.g. 3,2).', answer: '3,2', accept: ['(3,2)'],
...
const EXPERT: Question[] = [
  ...
  { id: 'e12', level: 'expert', topic: 'powers', type: 'entry',
    prompt: 'What is 12 × 12 × 12?', answer: '1728' },
  ...
  { id: 'e18', level: 'expert', topic: 'coordinates', type: 'entry',
    prompt: 'Write the coordinates of the point (e.g. 5,7).', answer: '5,7', accept: ['(5,7)'],
