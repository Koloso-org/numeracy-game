...
const styles = StyleSheet.create({
  ...
  rowMe: { backgroundColor: '#0b3a4a', borderWidth: 2, borderColor: COLORS.accent },
  rank: { color: COLORS.muted, fontSize: 16, fontWeight: '800', width: 52 },
  name: { color: COLORS.text, fontSize: 18, fontWeight: '700', flex: 1 },
  score: { color: COLORS.text, fontSize: 18, fontWeight: '800' },
  textMe: { color: COLORS.accent },
  pinned: {
    paddingHorizontal: 20,
    paddingBottom: 24,
    paddingTop: 8,
